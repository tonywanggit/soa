<%@ Page Title="" Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="ResTimeAnalyse.aspx.cs" Inherits="Analyse_ResTimeAnalyse" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="phContent" Runat="Server">
    <dxm:ASPxMenu Width="100%" HorizontalAlign="Left"  SkinID="ChartDemoToolbar" ID="mnuToolbar" runat="server" ClientInstanceName="mnuToolbar" AutoSeparators="None" ApplyItemStyleToTemplates="True">
        <Items>
            ...
            <dxm:MenuItem Name="mnuLblType" BeginGroup="True">
                <Template><dxe:ASPxLabel ID="lblType" Cursor="auto" Text="&nbsp;统计系统:" Visible="false" runat="server" /></Template>
            </dxm:MenuItem>
    ...
    <br />    
    <dxchartsui:WebChartControl ID="chart" runat="server" Height="800px" Width="900px" ClientInstanceName="chart" OnCustomCallback="chart_CustomCallback" >
