...
namespace ESB.Core.Entity
{
    ...
    public class AuditBusinessView : AuditBusinessView<AuditBusinessView> { }
    
    /// <summary></summary>
    public partial class AuditBusinessView<TEntity> : Entity<TEntity> where TEntity : AuditBusinessView<TEntity>, new()
    {
        #region 对象操作﻿
        static AuditBusinessView()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}AuditBusinessView数据……", typeof(TEntity).Name);

        //    var entity = new AuditBusinessView();
        //    entity.Name = "admin";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}AuditBusinessView数据！", typeof(TEntity).Name);
        //}
        #endregion
