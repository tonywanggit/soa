...
namespace ESB.Core.Entity
{
    ...
    public class BusinessService : BusinessService<BusinessService> { }
    
    /// <summary></summary>
    public partial class BusinessService<TEntity> : Entity<TEntity> where TEntity : BusinessService<TEntity>, new()
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BusinessService数据……", typeof(TEntity).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BusinessService数据！", typeof(TEntity).Name);
        //}
        #endregion
        ...
        ///// <summary>该BusinessService所对应的Personal</summary>
        //[XmlIgnore]
        //public Personal Personal
        //{
        //    get
        //    {
        //        if (_Personal == null && PersonalID > 0 && !Dirtys.ContainsKey("Personal"))
        //        {
        //            _Personal = Personal.FindByPersonalID(PersonalID);
        //            Dirtys["Personal"] = true;
        //        }
        //        return _Personal;
        //    }
        //    set { _Personal = value; }
        ...
        /// <returns></returns>
        public static TEntity FindByServiceName(String serviceName)
        {
            if (Meta.Count >= 1000)
