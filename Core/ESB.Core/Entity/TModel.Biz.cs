...
namespace ESB.Core.Entity
{
    ...
    public class TModel : TModel<TModel> { }
    
    /// <summary></summary>
    public partial class TModel<TEntity> : Entity<TEntity> where TEntity : TModel<TEntity>, new()
    {
        #region 对象操作﻿
        static TModel()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}TModel数据……", typeof(TEntity).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}TModel数据！", typeof(TEntity).Name);
        //}
        #endregion
        ...
        #region 扩展查询﻿
        /// <summary>根据ModelID查找</summary>
        /// <param name="modelid"></param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<TEntity> FindAllByModelID(Guid modelid)
        {
            if (Meta.Count >= 1000)
