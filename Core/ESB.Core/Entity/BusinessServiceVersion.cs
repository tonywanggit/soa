...
namespace ESB.Core.Entity
{
    ...
    public partial class BusinessServiceVersion<TEntity> : IBusinessServiceVersion
    {
        ...
        /// <summary>0：未启用，1：提交评审，2：评审通过</summary>
        [DisplayName("0：未启用，1：提交评审，2：评审通过")]
        [Description("0：未启用，1：提交评审，2：评审通过")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(10, "Status", "0：未启用，1：提交评审，2：评审通过", "0", "int", 10, 0, false)]
