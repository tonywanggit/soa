...
namespace ESB.Core.Entity
{
    ...
    public class ReturnResponse : ReturnResponse<ReturnResponse> { }
    
    /// <summary></summary>
    public partial class ReturnResponse<TEntity> : Entity<TEntity> where TEntity : ReturnResponse<TEntity>, new()
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ReturnResponse数据……", typeof(TEntity).Name);

        //    var entity = new ReturnResponse();
        //    entity.Name = "admin";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ReturnResponse数据！", typeof(TEntity).Name);
        //}
        #endregion
