...
namespace ESB.Core.Entity
{
    ...
    public class BindingTemplate : BindingTemplate<BindingTemplate> { }
    
    /// <summary></summary>
    public partial class BindingTemplate<TEntity> : Entity<TEntity> where TEntity : BindingTemplate<TEntity>, new()
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BindingTemplate数据……", typeof(TEntity).Name);

        //    var entity = new BindingTemplate();
        //    entity.Name = "admin";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BindingTemplate数据！", typeof(TEntity).Name);
        //}
        #endregion
        ...
        #region 扩展查询﻿
        /// <summary>根据TemplateID查找</summary>
