...
namespace ESB.Core.Entity
{
    ...
    public class ShowTodayWatch : ShowTodayWatch<ShowTodayWatch> { }
    
    /// <summary></summary>
    public partial class ShowTodayWatch<TEntity> : Entity<TEntity> where TEntity : ShowTodayWatch<TEntity>, new()
    {
        #region 对象操作﻿
        static ShowTodayWatch()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ShowTodayWatch数据……", typeof(TEntity).Name);

        //    var entity = new ShowTodayWatch();
        //    entity.Name = "admin";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ShowTodayWatch数据！", typeof(TEntity).Name);
        //}
        #endregion
