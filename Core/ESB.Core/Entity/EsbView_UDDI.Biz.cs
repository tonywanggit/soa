...
namespace ESB.Core.Entity
{
    ...
    public class EsbView_UDDI : EsbView_UDDI<EsbView_UDDI> { }
    
    /// <summary></summary>
    public partial class EsbView_UDDI<TEntity> : Entity<TEntity> where TEntity : EsbView_UDDI<TEntity>, new()
    {
        #region 对象操作﻿
        static EsbView_UDDI()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}EsbView_UDDI数据……", typeof(TEntity).Name);

        //    var entity = new EsbView_UDDI();
        //    entity.Name = "admin";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}EsbView_UDDI数据！", typeof(TEntity).Name);
        //}
        #endregion
