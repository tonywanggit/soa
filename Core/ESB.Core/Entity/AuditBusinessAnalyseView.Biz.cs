...
namespace ESB.Core.Entity
{
    ...
    public class AuditBusinessAnalyseView : AuditBusinessAnalyseView<AuditBusinessAnalyseView> { }
    
    /// <summary></summary>
    public partial class AuditBusinessAnalyseView<TEntity> : Entity<TEntity> where TEntity : AuditBusinessAnalyseView<TEntity>, new()
    {
        #region 对象操作﻿
        static AuditBusinessAnalyseView()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}AuditBusinessAnalyseView数据……", typeof(TEntity).Name);

        //    var entity = new AuditBusinessAnalyseView();
        //    entity.Name = "admin";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}AuditBusinessAnalyseView数据！", typeof(TEntity).Name);
        //}
        #endregion
