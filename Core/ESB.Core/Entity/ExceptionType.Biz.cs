...
namespace ESB.Core.Entity
{
    ...
    public class ExceptionType : ExceptionType<ExceptionType> { }
    
    /// <summary></summary>
    public partial class ExceptionType<TEntity> : Entity<TEntity> where TEntity : ExceptionType<TEntity>, new()
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}ExceptionType数据……", typeof(TEntity).Name);

        //    var entity = new ExceptionType();
        //    entity.Name = "admin";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}ExceptionType数据！", typeof(TEntity).Name);
        //}
        #endregion
        ...
        public static TEntity FindByTypeId(Int32 typeid)
        {
            if (Meta.Count >= 1000)
