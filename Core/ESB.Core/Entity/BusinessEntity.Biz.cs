...
namespace ESB.Core.Entity
{
    ...
    public class BusinessEntity : BusinessEntity<BusinessEntity> { }
    
    /// <summary></summary>
    public partial class BusinessEntity<TEntity> : Entity<TEntity> where TEntity : BusinessEntity<TEntity>, new()
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}BusinessEntity数据……", typeof(TEntity).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}BusinessEntity数据！", typeof(TEntity).Name);
        //}
        #endregion
        ...
        #region 扩展查询﻿
        /// <summary>根据BusinessID查找</summary>
