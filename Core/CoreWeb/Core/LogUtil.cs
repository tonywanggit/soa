...
namespace CoreWeb.Core
{
    public class LogUtil
    {
        ...
        /// <returns></returns>
        public static Exception ExceptionAndLog(String exceptionDesc, String message, JN.ESB.Schemas.服务请求 request)
        {
        ...
        /// <param name="binding"></param>
        /// <param name="request"></param>
        public static Exception ExceptionAndLog(String exceptionDesc, String message, BindingTemplate binding, JN.ESB.Schemas.服务请求 request)
        {
        ...
        /// <param name="binding"></param>
        /// <param name="request"></param>
        public static Exception ExceptionAndLog(CallState state, String exceptionDesc, String message, BindingTemplate binding, JN.ESB.Schemas.服务请求 request)
        {
